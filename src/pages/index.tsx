...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>{data?.homeService.data.attributes.seo.metaTitle}</title>
        <meta
          name="description"
          content={data?.homeService.data.attributes.seo.metaDescription}
          key="desc"
        />
        <meta
          name="title"
          content={data?.homeService.data.attributes.seo.metaTitle}
        />
      </Head>
      <main>
        <Hero />
